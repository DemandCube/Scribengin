...
import com.neverwinterdp.scribengin.ScribenginFlowMaster;
import com.neverwinterdp.scribengin.Scribengin;
...
public class TestUtil implements Runnable {
  ...
  public TestUtil(ScribenginFlowMaster flowMaster) throws InterruptedException {
    ...
    zkHelper = new ZookeeperHelper(ScribenginUtils.getZookeeperServers(Scribengin.props));
  }
