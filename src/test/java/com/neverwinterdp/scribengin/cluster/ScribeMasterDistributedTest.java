 ...
 *
 */
public class ScribeMasterDistributedTest{
  static {
  ...
  private static final Logger LOG = Logger.getLogger(ScribeMasterDistributedTest.class.getName());
  ...
  @Test
  public void ScribeConsumerDevTest() throws InterruptedException{
