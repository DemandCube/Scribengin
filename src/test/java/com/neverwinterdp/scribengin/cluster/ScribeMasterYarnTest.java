 ...
 *
 */
public class ScribeMasterYarnTest{
  static {
  ...
  private static final Logger LOG = Logger.getLogger(ScribeMasterYarnTest.class.getName());
  ...
  @Ignore
  @Test
  public void ScribeConsumerYarnTest() throws InterruptedException{
