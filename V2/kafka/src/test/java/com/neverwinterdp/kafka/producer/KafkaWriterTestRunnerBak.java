 ...
 * @author Tuan
 */
public class KafkaWriterTestRunnerBak {
  ...
  public KafkaWriterTestRunnerBak(AckKafkaWriterTestRunnerConfig config) {
    this.config = config;
  ...
  public void run() throws Exception {
    ...
    KafkaMessageSendTool sendTool = 
      new KafkaMessageSendTool(config.getTopic(), config.getMaxNumOfMessages(), config.getMessageSize());
    ...
    KafkaMessageCheckTool checkTool = 
      new KafkaMessageCheckTool(cluster.getZKConnect(), config.getTopic(), config.getMaxNumOfMessages());
