...
import com.neverwinterdp.vm.DummyVMApplication;
...
public class VMServiceUnitTest extends ScribenginUnitTest {
  ...
  public void testVMService() throws Exception {
    Injector container = newAppContainer() ;
    ...
    for(int i = 0; i < 10; i++) {
      ...
      props.put("name", "Dummy-" +i);
      Command startCmd = new VMCommand.AppStart(DummyVMApplication.class.getName(), props) ;
    ...
    Thread.sleep(2000);
    VMDescriptor[] allocatedVMs = vmService.getAllocatedVMDescriptors();
