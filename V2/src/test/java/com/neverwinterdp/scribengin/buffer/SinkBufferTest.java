...
public class SinkBufferTest {
  ...
  public void testAdd() {
    ...
    for (int i = 0; i < tuples; i++) {
      tuple = new Tuple(Integer.toString(i), new byte[10],
          new CommitLogEntry("key", i, i));
      buffer.add(tuple);
    }
  ...
  public void testAppendTuplesToMemory() {
    ...
    int tuples = 1000;
    for (int i = 0; i < tuples; i++) {
      Tuple tuple = new Tuple(Integer.toString(i), new byte[10],
          new CommitLogEntry(
              "key", i, i));
      buffer.add(tuple);
    }
  ...
  public void testPollFromDisk() {
    ...
    for (int i = 0; i < tuples; i++) {
      Tuple tuple = new Tuple(Integer.toString(i), (message + i).getBytes(),
          new CommitLogEntry(
              "key", i, i));
      buffer.add(tuple);
    }
  ...
  @Test
  public void testGetTuplesCount() {
    int tuples = 1000;
    for (int i = 0; i < tuples; i++) {
      Tuple tuple = new Tuple(Integer.toString(i), new byte[10],
          new CommitLogEntry(
