  ...
  public class DataflowSubmitter extends Thread {
    public void run() {
      try {
        String command = 
          "dataflow-test kafka " + 
          "  --worker 2 --executor-per-worker 2 --duration 180000 --task-max-execute-time 1000" +
          "  --kafka-num-partition 10 --kafka-write-period 5 --kafka-max-message-per-partition 5000";
