...
public class DataflowTaskMonitorBackup extends NodeChildrenWatcher {
  ...
  public DataflowTaskMonitorBackup(DataflowRegistry dflRegistry) throws RegistryException {
